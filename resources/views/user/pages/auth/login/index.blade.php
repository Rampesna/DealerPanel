                ...
                <div class="login-form">
                    <div class="form" id="login">
                        <div class="pb-5 pb-lg-15">
                            <h3 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg">Yönetici Girişi</h3>
                        </div>
                        ...
                        <div class="pb-lg-0 pb-5">
                            <div class="row">
                                <div class="col-xl-4">
                                    <button type="button" class="btn btn-primary btn-block font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3" id="LoginButton">Giriş Yap</button>
                                </div>
                                <div class="col-xl-8">
...
@section('page-styles')
    @include('user.pages.auth.login.components.style')
@stop

@section('page-script')
    @include('user.pages.auth.login.components.script')
@stop
