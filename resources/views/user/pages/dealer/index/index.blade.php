...
@section('content')
    ...
    @include('user.pages.dealer.index.modals.create')
    @include('user.pages.dealer.index.modals.edit')
    @include('user.pages.dealer.index.modals.delete')
    ...
    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" id="context-menu" style="width: 300px">
        <a onclick="create()" class="dropdown-item cursor-pointer">
            <div class="row">
                <div class="col-xl-12">
                    <i class="fas fa-plus-circle text-success"></i><span class="ml-4">Bayi Oluştur</span>
                </div>
            </div>
        </a>
...
@section('page-styles')
    @include('user.pages.dealer.index.components.style')
@stop

@section('page-script')
    @include('user.pages.dealer.index.components.script')
@stop
