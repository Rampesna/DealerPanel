...
@section('content')
    ...
    @include('user.pages.dealer.show.dealerUser.modals.create')
    @include('user.pages.dealer.show.dealerUser.modals.edit')
    @include('user.pages.dealer.show.dealerUser.modals.delete')
...
@section('page-styles')
    @include('user.pages.dealer.show.dealerUser.components.style')
@stop

@section('page-script')
    @include('user.pages.dealer.show.dealerUser.components.script')
@stop
