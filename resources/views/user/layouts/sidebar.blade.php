<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
    <div class="brand flex-column-auto" id="kt_brand">
        <a href="#" class="brand-logo" style="height: 20px">
    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
            <ul class="menu-nav">
                ...
                <li class="menu-item {{ request()->segment(2) === 'dealer' ? 'menu-item-active' : null }}"
                    aria-haspopup="true">
                    <a href="{{ route('user.dealer.index') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" >
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <li class="menu-item {{ request()->segment(2) === 'customer' ? 'menu-item-active' : null }}"
                    aria-haspopup="true">
                ...
                <li class="menu-item {{ request()->segment(2) === 'opportunity' ? 'menu-item-active' : null }}" aria-haspopup="true">
                    <a href="{{ route('user.opportunity.index') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" >
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                ...
                <li class="menu-item {{ request()->segment(2) === 'waitingTransaction' ? 'menu-item-active' : null }}" aria-haspopup="true">
                    <a href="{{ route('user.waitingTransaction.show', ['tab' => 'customer']) }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" >
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                        ...
                        <span class="menu-text">Onay Bekleyen İşlemler</span>
                    </a>
                </li>
                <li class="menu-item {{ request()->segment(2) === 'batchTransaction' ? 'menu-item-active' : null }}" aria-haspopup="true">
                    <a href="{{ route('user.batchTransaction.index') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" >
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                        ...
                        <span class="menu-text">Toplu İşlemler</span>
                    </a>
                </li>
                <li class="menu-item {{ request()->segment(2) === 'supportRequest' ? 'menu-item-active' : null }}" aria-haspopup="true">
                    <a href="{{ route('user.supportRequest.index') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" >
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                ...
                <li class="menu-item {{ request()->segment(2) === 'report' ? 'menu-item-active' : null }}" aria-haspopup="true">
                ...
                <li class="menu-item {{ request()->segment(2) === 'service' ? 'menu-item-active' : null }}" aria-haspopup="true">
                    <a href="{{ route('user.service.index') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" >
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                ...
                <li class="menu-item {{ request()->segment(2) === 'user' ? 'menu-item-active' : null }}" aria-haspopup="true">
                    <a href="{{ route('user.user.index') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" >
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <polygon points="0 0 24 0 24 24 0 24"/>
