    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
            <ul class="menu-nav">
                ...
                <li class="menu-item {{ request()->segment(2) === 'dashboard' ? 'menu-item-active' : null }}" aria-haspopup="true">
                ...
                <li class="menu-item {{ request()->segment(2) === 'customer' ? 'menu-item-active' : null }}" aria-haspopup="true">
                    <a href="{{ route('dealerUser.customer.index') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" >
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <polygon points="0 0 24 0 24 24 0 24"/>
                ...
                <li class="menu-item {{ request()->segment(2) === 'credit' ? 'menu-item-active' : null }}"
                    aria-haspopup="true">
                    <a href="{{ route('dealerUser.credit.index') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" >
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <li class="menu-item {{ request()->segment(2) === 'finance' ? 'menu-item-active' : null }}" aria-haspopup="true">
                    <a href="{{ route('dealerUser.finance.index') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" >
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                ...
                <li class="menu-item {{ request()->segment(2) === 'opportunity' ? 'menu-item-active' : null }}" aria-haspopup="true">
                    <a href="{{ route('dealerUser.opportunity.index') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" >
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                ...
                <li class="menu-item {{ request()->segment(2) === 'dealer' ? 'menu-item-active' : null }}" aria-haspopup="true">
                    <a href="{{ route('dealerUser.dealer.index') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" >
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                        ...
                        <span class="menu-text">Alt Bayiler</span>
                    </a>
                </li>
                ...
                <li class="menu-item {{ request()->segment(2) === 'report' ? 'menu-item-active' : null }}" aria-haspopup="true">
                    <a href="{{ route('dealerUser.report.index') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" >
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
