...
@section('title', 'Bayi Kontör Raporu')
...
@section('page-styles')
    @include('dealerUser.pages.dealer.show.credit.components.style')
@stop

@section('page-script')
    @include('dealerUser.pages.dealer.show.credit.components.script')
@stop
