@extends('customer.layouts.authentication')
                ...
                <div class="login-form">
                    <div class="form" id="login">
                        <div class="pb-5 pb-lg-15">
                            <h3 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg">Müşteri Girişi</h3>
                        </div>
...
@section('page-styles')
    @include('customer.pages.auth.login.components.style')
@stop

@section('page-script')
    @include('customer.pages.auth.login.components.script')
@stop
