<script>
    ...
    function getSupportRequest() {
        $.ajax({
            type: 'get',
            url: '{{ route('api.v1.customer.supportRequest.show') }}',
            headers: {
    ...
    function save(method, data) {
        ...
        $.ajax({
            type: method,
            url: '{{ route('api.v1.customer.supportRequestMessage.save') }}',
            headers: {
                _token: '{{ auth()->user()->apiToken() }}',
                _auth_type: 'Customer'
            },
    ...
    function updateStatus(status_id) {
        ...
        $.ajax({
            type: 'put',
            url: '{{ route('api.v1.customer.supportRequest.updateStatus') }}',
            headers: {
                _token: '{{ auth()->user()->apiToken() }}',
                _auth_type: 'Customer'
            },
